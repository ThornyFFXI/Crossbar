...
//
//  Microsoft Research Detours Package, Version 3.0 Build_338.
//
...
// Notes from atom0s:
//
//  This version of Detours has been compiled on my personal home machine
//  specifically for the Ashita project. I have altered this header and
//  some code in the lib to ensure it will work and compile for 32bit
//  usages only. I do not recommend using this in your own projects!
//
//  You can find the original copy of Detours 3 express here:
//  https://www.microsoft.com/en-us/download/details.aspx?id=52586
//
//  Compiler Setup:
//    - Visual Studio 2015 w/ Update 3
//    - Removal of most 64bit #defines in the source code.
//    - Removal of some non-used chunks of code to slim the lib some.
//
//////////////////////////////////////////////////////////////////////////////
...
#undef _ARM_
#undef _ARM64_
#undef DETOURS_X64_OFFLINE_LIBRARY
#undef DETOURS_ARM_OFFLINE_LIBRARY
#undef DETOURS_ARM64_OFFLINE_LIBRARY
#undef DETOURS_IA64_OFFLINE_LIBRARY
#undef DETOURS_X86_OFFLINE_LIBRARY

#define _X86_


#if defined(_WIN64) || defined(_AMD64_) || defined(_IA64_) || defined(_ARM_) || defined(_ARM64_)
#error Cannot compile under a 64bit machine settings. Correct this header as needed.
#endif

#if defined(DETOURS_ARM_OFFLINE_LIBRARY) || defined(DETOURS_ARM64_OFFLINE_LIBRARY) || defined(DETOURS_IA64_OFFLINE_LIBRARY)
#error Cannot compile under a 64bit machine settings. Correct this header as needed.
#endif
